...
public class PhLogger implements ILogger, Serializable {
	
	private static final long serialVersionUID = -4430855194417471015L;
	
	private static Logger logger = LoggerFactory.getLogger(PhLogger.class);
	
	public static PhLogger getInstance(){
		return Instance.logger;
	}
	
	private static class Instance{
		private static PhLogger logger = new PhLogger();
	}
