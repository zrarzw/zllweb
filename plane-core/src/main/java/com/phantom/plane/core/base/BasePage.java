...
public class BasePage {
	...
	public BasePage(Integer page, Integer rp) {
		super();
		this.page = page;
		this.rp = rp;
	}

	public BasePage(Integer page, Integer rp, String sortName) {
		super();
		this.page = page;
		this.rp = rp;
	...
	public BasePage(Integer page, Integer rp, String sortName, String sortOrder) {
		super();
		this.page = page;
		this.rp = rp;
		this.sortName = sortName;
	...
	public static BasePage createMaxPageDto(){
		BasePage flexiPageDto=new BasePage();
		flexiPageDto.setRp(MAX_PAGE_SIZE).setPage(1);
		return flexiPageDto;
	}
	public static BasePage generateFlexiPageDto(Integer page, Integer rp, String orderBy) {
		BasePage flexiPageDto = new BasePage(page, rp);
	...
	public BasePage setRp(Integer rp) {
		this.rp = rp;
		return this;
	}
	...
	public BasePage setPage(Integer page) {
		this.page = page;
		return this;
	}
	...
	public BasePage setSortName(String sortName) {
		this.sortName = sortName;
		return this;
	}
	...
	public BasePage setSortOrder(String sortOrder) {
		this.sortOrder = sortOrder;
		return this;
	}
	...
	public BasePage setRowCount(Integer rowCount) {
